      ...
      <table className="w-full border-collapse text-[10px]">
        <thead>
          <tr className="bg-blue-950 text-white">
            ...
            <th className="border border-blue-200 px-1 sm:px-2 py-1 sm:py-1.5 text-left">
              รายการ
            </th>
            <th className="border border-blue-200 px-1 sm:px-2 py-1 sm:py-1.5 text-center w-10 sm:w-20">
              จำนวน
            </th>
            <th className="border border-blue-200 px-1 sm:px-2 py-1 sm:py-1.5 text-right w-16 sm:w-28">
              ราคา/หน่วย
            </th>
            <th className="border border-blue-200 px-1 sm:px-2 py-1 sm:py-1.5 text-right w-16 sm:w-28">
              รวม
