    ...
    <div className="mb-3">
      ...
      {hasPaymentTerms && hasBankInfo ? (
        <div>
          ...
          <div className="flex items-stretch gap-3">
            ...
            <div className="flex-1 min-w-0 relative">
              <div className="absolute inset-0 rounded border border-blue-400 bg-blue-50/50 p-2 flex flex-col overflow-hidden">
            ...
            <div className="w-full max-w-sm shrink-0 flex flex-col">
              <table className="w-full border-collapse text-[10px]">
                <thead>
                  <tr className="bg-blue-100">
                    <th className="border border-blue-400 px-1 sm:px-2 py-1 text-center w-10 sm:w-14">
                      งวดที่
                    </th>
                    <th className="border border-blue-400 px-1 sm:px-2 py-1 text-left">
                      เงื่อนไขการชำระเงิน
                    </th>
                    <th className="border border-blue-400 px-1 sm:px-2 py-1 text-right w-20 sm:w-28">
                      จำนวนเงิน (บาท)
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {paymentTerms.map((term) => (
                    <tr key={term.sequence}>
                      <td className="border border-blue-400 px-1 sm:px-2 py-1 text-center text-gray-600">
                        {term.sequence}
                      </td>
                      <td className="border border-blue-400 px-1 sm:px-2 py-1 text-gray-700">
                      ...
                      <td className="border border-blue-400 px-1 sm:px-2 py-1 text-right font-medium text-gray-900">
              ...
              {hasDeliveryInfo && (
                <div className="rounded border border-blue-400 p-2 mt-2">
        ...
        <>
          ...
          {hasPaymentTerms && (
            <div className="mb-4">
              ...
              <table className="w-full border-collapse text-[10px]">
                <thead>
                  <tr className="bg-blue-100">
                    <th className="border border-blue-400 px-1 sm:px-2 py-1 text-center w-10 sm:w-16">
                      งวดที่
                    </th>
                    <th className="border border-blue-400 px-1 sm:px-2 py-1 text-left">
                      เงื่อนไขการชำระเงิน
                    </th>
                    <th className="border border-blue-400 px-1 sm:px-2 py-1 text-right w-20 sm:w-32">
                      จำนวนเงิน (บาท)
                    </th>
                  </tr>
                </thead>
          ...
          {hasBankInfo && (
            <div className="rounded border border-blue-400 bg-blue-50/50 p-3">
